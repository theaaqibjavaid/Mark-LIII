...
TOOL = {"name": "email_message", "description": "Retrieve email messages, change read state, or prepare reply/reply-all/forward actions behind the trusted confirmation gate.", "parameters": {"type": "OBJECT", "properties": {"operation": {"type": "STRING"}, "account_id": {"type": "STRING"}, "mailbox": {"type": "STRING"}, "uid": {"type": "STRING"}, "body": {"type": "STRING"}, "html": {"type": "STRING"}, "recipients": {"type": "ARRAY", "items": {"type": "STRING"}}, "confirmed": {"type": "BOOLEAN"}, "operation_id": {"type": "STRING"}}, "required": ["operation", "account_id", "mailbox", "uid"]}, "handler": _handler}
