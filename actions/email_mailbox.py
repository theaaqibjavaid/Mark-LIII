...
TOOL = {"name": "email_mailbox", "description": "List folders and perform mailbox/message state operations; delete and bulk delete always use trusted confirmation.", "parameters": {"type": "OBJECT", "properties": {"operation": {"type": "STRING"}, "account_id": {"type": "STRING"}, "mailbox": {"type": "STRING"}, "uid": {"type": "STRING"}, "target_folder": {"type": "STRING"}, "flag": {"type": "STRING"}, "confirmed": {"type": "BOOLEAN"}, "refs": {"type": "ARRAY", "items": {"type": "OBJECT", "properties": {"mailbox": {"type": "STRING"}, "uid": {"type": "STRING"}}, "required": ["mailbox", "uid"]}}}, "required": ["operation", "account_id"]}, "handler": _handler}
