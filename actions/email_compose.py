...
TOOL = {"name": "email_compose", "description": "Create or update drafts, or send an email only after the trusted user confirmation gate; draft operations never send.", "parameters": {"type": "OBJECT", "properties": {"operation": {"type": "STRING"}, "account_id": {"type": "STRING"}, "to": {"type": "ARRAY"}, "cc": {"type": "ARRAY"}, "bcc": {"type": "ARRAY"}, "reply_to": {"type": "STRING"}, "subject": {"type": "STRING"}, "body": {"type": "STRING"}, "html": {"type": "STRING"}, "attachments": {"type": "ARRAY"}, "draft_id": {"type": "STRING"}, "mailbox": {"type": "STRING"}, "uid": {"type": "STRING"}, "operation_id": {"type": "STRING"}, "confirmed": {"type": "BOOLEAN"}}, "required": ["operation", "account_id"]}, "handler": _handler}
